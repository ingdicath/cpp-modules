...
//	AAnimal *j = new AAnimal(); // It is not possible. AAnimal is now an abstract class
//	AAnimal animal; // It is not possible. AAnimal is now an abstract class
